...
\newcommand{\course}[3]{
  \stepcounter{course}
  \begin{tabularx}{\linewidth}{ >{\hsize=0.1\hsize}L >{\hsize=1.9\hsize}X >{\hsize=1.4\hsize}X >{\hsize=0.6\hsize}X }
...
\newcommand{\educationsection}{
  \begin{mysection}{education}
    ...
    \dateitem{Doctor of Medicine}{2023 (expected)}
    \dateitem{Doctor of Philosophy, Bioinformatics \& Computational Biology}{2021 (expected)}
    \newline
...
\begin{mysection}{experience}
  ...
  \textbf{UNC School of Medicine, Chapel Hill, NC} \newline
  \dateitem{Graduate Research Assistant, Wilhelmsen Laboratory}{2017 -- }
  ...
  \dateitem{ORISE Research Fellow}{2012 -- 2016} 
...
\begin{mysection}{teaching}
  ...
  \course{How to Learn to Code}{UNC School of Medicine}{Summer, 2019}
  \course{How to Learn to Code}{UNC School of Medicine}{Summer, 2018}
  \course{How to Learn to Code}{UNC School of Medicine}{Summer, 2016} 
  ...
  \course{MAT151, Calculus I (TA)}{College of Idaho}{Spring, 2011}
  \course{BIO220, Freshman Biology II (TA)}{College of Idaho}{Spring, 2011}
  \course{MAT151, Calculus I (TA)}{College of Idaho}{Fall, 2010}
...
\begin{mysection}{service and awards}
